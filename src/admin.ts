...
import type { ProjectFileInfo, ProjectMetadata, ProjectSummary } from "./projects/store.js";
...
<body>
  ...
  <main>
    ...
    <section>
      <h2>Projects</h2>
      ${projectRows ? `<table><thead><tr><th>Title / ID</th><th>Status</th><th>Files</th><th>Updated</th><th>Created by</th><th>Published URL</th><th>Actions</th></tr></thead><tbody>${projectRows}</tbody></table>` : `<div class="empty">No projects created yet.</div>`}
    </section>
    <section>
