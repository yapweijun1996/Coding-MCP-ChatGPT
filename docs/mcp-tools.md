...
- Music workflow: `import_musicxml_score`, `validate_music_ensemble`, `compose_music`, `edit_midi`, `check_music_render_environment`, `render_production_music`, `install_free_soundfont_pack`, `discover_soundfont_packs`, `render_midi_with_soundfont`, `render_midi_to_audio`, `inspect_audio_quality`, `manage_jazz_instrument_packs`, `build_music_license_manifest`, `publish_music_audition_demo`, `export_music_project`, and supporting arrangement/export tools.
